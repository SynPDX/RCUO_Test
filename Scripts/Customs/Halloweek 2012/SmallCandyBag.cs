...
{
	public class SmallCandyBag : BaseContainer, IDyable
	{
		[Constructable]
		public SmallCandyBag() : base( 0xE75 )
		{
			Layer = Layer.Backpack;
			Weight = 3.0;
			Name = "A Small Halloween Candy Bag";
			HalloweenCandyBagColor();
		}
		public virtual void HalloweenCandyBagColor()
        {
		...
		public SmallCandyBag( Serial serial ) : base( serial )
		{
		}
