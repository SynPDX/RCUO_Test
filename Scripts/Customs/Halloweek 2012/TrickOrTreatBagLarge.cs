...
{
	public class TrickOrTreatBagLarge : BaseContainer
	{
		[Constructable]
		public TrickOrTreatBagLarge() : base( 0xE76 )
		{
			Weight = 2.0;
			Name = "A Large Trick Or Treat Bag";

			HalloweenColor();
            Candy(7);
			RareDrop(1);
		}
		public virtual void RareDrop(int amount)
        {
	...
	public virtual void HalloweenColor()
		...
		public TrickOrTreatBagLarge( Serial serial ) : base( serial )
		{
		}
