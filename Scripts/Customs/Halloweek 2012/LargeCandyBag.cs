...
{
	public class LargeCandyBag : BaseContainer, IDyable
	{
		[Constructable]
		public LargeCandyBag() : base( 0xE75 )
		{
			Layer = Layer.Backpack;
			Weight = 3.0;
			Name = "A Large Halloween Candy Bag";
			HalloweenLCandyBagColor();
		}
		public virtual void HalloweenLCandyBagColor()
        {
		...
		public LargeCandyBag( Serial serial ) : base( serial )
		{
		}
