...
{
	[CorpseName( "a milk chocolate dragon corpse" )]
	public class MilkChocolateDragon : BaseCreature
	{
		[Constructable]
		public MilkChocolateDragon () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a milk chocolate dragon";
			...
			{
				case 0: PackItem( new MilkChocolateDragonF() ); break;
				case 1: PackItem( new ChocolateDragonSkull() ); break;
				case 2: PackItem( new MilkChocolateScales(5) ); break;
			}
		}
		public virtual void RareDropMCD(int amount)
        {
		...
		public virtual void TokenDropMCD(int amount)
        {
		...
		public MilkChocolateDragon( Serial serial ) : base( serial )
		{
		}
