...
{
	[CorpseName( "a dark chocolate dragon corpse" )]
	public class DarkChocolateDragon : BaseCreature
	{
		[Constructable]
		public DarkChocolateDragon () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a dark chocolate dragon";
			...
			{
				case 0: PackItem( new DarkChocolateDragonF() ); break;
				case 1: PackItem( new ChocolateDragonSkull() ); break;
				case 2: PackItem( new DarkChocolateScales(5) ); break;
			}
		}
		public virtual void RareDropDCD(int amount)
        {
		...
		public virtual void TokenDropDCD(int amount)
        {
		...
		public DarkChocolateDragon( Serial serial ) : base( serial )
		{
		}
