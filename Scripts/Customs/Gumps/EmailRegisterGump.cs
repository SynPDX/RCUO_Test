...
namespace Server.Gumps
{
	public class RegisterEmailGump : Gump
	{
		...
		public RegisterEmailGump() : base(0, 0)
		{
			...
			AddLabel(234, 376, 0, "Register Address");
                ...
                case 1:
                    {
                        ...
                        if (ValidateEmail(txt1, txt2))
                        {
                            ...
                            from.SendMessage("Please check your email, you have been sent a confirmation code! \n This code will expire if you logout, so please check soon!");
                        }
                        else
                        {
