...
namespace Server.Gumps
{
	public class AuthGump : Gump
	{
            ...
            : base(0, 0)
		{
			...
			AddHtml(155, 184, 347, 119, "Enter the 10 character long registration code that was sent to your email after you submitted it. However, if you have logged out since submitting your email, your 10 character registration code has expired and you will need to submit your request again.", true, false);
                ...
                case 1:
                    {
                        ...
                        if (CanValidate(s, key, from))
                        {
                            ...
                            string msg = "Congragulations on sucessfully registering your email address, You will now be able to recieve special announcments via email and use the in game commands \"[account\" to manage your password and email address and \"[email\" to send emails to other players. \n \n" + "Thank You - Rotting Corpse Staff";
