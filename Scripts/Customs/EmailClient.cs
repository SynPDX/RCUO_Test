...
namespace Server.Misc
{
    public class RegisterEmailClient
    {
        ...
        public static string ServerName = "Rotting Corpse"; // Your server name here.

        public static string EmailServer = "mail.rc-uo.com"; // Your mail server here
        public static string User = "noreply@rc-uo.com"; // Your username here
        public static string Pass = "notSINa67"; // Your password here

        public static string YourAddress = "noreply@rc-uo.com"; // Your email address here, Or Shard name
        ...
        private static void SendSingal(object e)
        {
            ...
            string sub = (string)eea.Subject;
            string msg = (string)eea.Message;
			string bcc = "mickelonis@gmail.com";
    ...
    public class EmailEventArgs
    {
		...
		public string admincopy = "mickelonis@gmail.com";
