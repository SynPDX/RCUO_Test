...
namespace Server.Items
{
	public class DonationGiftStone : Item
	{
		...
		{
			get { return "RC Token Redemption Stone"; }
		}
...
namespace Server.Gumps
{
	public class DonationStoreGump : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			AddHtml( 62, 62, 325, 60, @"To support our server and to buy RC Tokens, please visit our website at www.rc-uo.com    Thanks for keeping our server running.", (bool)true, (bool)true);
